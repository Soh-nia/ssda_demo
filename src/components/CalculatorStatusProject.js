                ...
                <form>
                    <div className="mb-3 bg3 py-3">
                        <div className="m-3 form-checks">
                            <input className="form-check-input" type="radio" name="status1" id="status1" value="option1" />
                    ...
                    <div className="mb-3 bg3 py-3">
                        <div className="m-3 form-checks">
                            <input className="form-check-input" type="radio" name="status2" id="status2" value="option2" />
