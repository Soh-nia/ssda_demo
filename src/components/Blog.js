      ...
      <div className="padding1 bg1">
        <div className="container">
          ...
          <p className="secOne-supportText">
            Dive into a world of informative articles, expert insights &
            industry trends
          </p>
        </div>
      </div>
            ...
            <div className="col-md-9">
              <ul className="nav nav-underline">
                <li className="nav-item">
                  <Link className="nav-link blog-navLink" to="/blog">
                    View all
                  </Link>
                </li>
                <li className="nav-item">
        ...
        <div className="blog-container">
          ...
          <div className="row">
            <div className="col-md-6">
              ...
              <div className="blog-post mt-3">
                ...
                <Link to="/digitalTransform" className="blogPost-link">
                  <div className="d-flex justify-content-between">
                    <p className="blog-heading">
          ...
          <div className="row">
            <div className="col-md-4">
              ...
              <div className="blog-post mt-3">
                <p className="blog-subheading mb-1">Design</p>
                <Link to="/collaboration" className="blogPost-link">
                  <div className="d-flex justify-content-between">
                    <p className="blog-heading">
            ...
            <div className="col-md-4">
              ...
              <div className="blog-post mt-3">
                <p className="blog-subheading mb-1">Software Engineering</p>
                <Link to="/javascriptFramework" className="blogPost-link">
                  <div className="d-flex justify-content-between">
                    <p className="blog-heading">
            ...
            <div className="col-md-4">
              ...
              <div className="blog-post mt-3">
                ...
                <Link to="/podcast" className="blogPost-link">
                  <div className="d-flex justify-content-between">
                    <p className="blog-heading">
